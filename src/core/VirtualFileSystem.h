...
public:
    ...
    virtual std::string FindFile(IN const char *filename, OUT Moho::SDiskFileInfo *info) = 0;
    virtual std::string Func1(const char *) = 0;
    virtual bool Func2(IN const char *, OUT Moho::SDiskFileInfo *) = 0;
...
public:
    ...
    std::string FindFile(IN const char *filename, OUT Moho::SDiskFileInfo *info) override; // 0x00466A20
    std::string Func1(const char *) override; // 0x
    bool Func2(IN const char *, OUT Moho::SDiskFileInfo *) override; // 0x00466E50
